...
@FirBuilderDsl
class FirReplExpressionReferenceBuilder : FirAnnotationContainerBuilder, FirExpressionBuilder {
    override var source: KtSourceElement? = null
    lateinit var expressionRef: FirExpressionRef<FirExpression>

    override fun build(): FirReplExpressionReference {
    ...
    @Deprecated("Modification of 'coneTypeOrNull' has no impact for FirReplExpressionReferenceBuilder", level = DeprecationLevel.HIDDEN)
...
inline fun buildReplExpressionReference(init: FirReplExpressionReferenceBuilder.() -> Unit): FirReplExpressionReference {
    contract {
